  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <div className="container max-w-5xl py-6 px-4">
        ...
        <div className="bg-orange-500/15 border border-orange-500/30 rounded-lg px-4 py-3 flex items-center gap-3 mb-6 animate-fade-up">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-3 mb-6">
          {[
            { icon: Droplets, circle: "icon-circle-blue", title: "Water Today", badge: "NOW", badgeColor: "text-blue-500 bg-blue-500/10", desc: "Soil moisture is low. Irrigate your wheat field this evening." },
            { icon: Clock, circle: "icon-circle-orange", title: "Delay Sowing", badge: "WAIT", badgeColor: "text-orange-500 bg-orange-500/10", desc: "Heavy rain expected in 3 days. Wait before sowing rice." },
            ...
            { icon: FlaskConical, circle: "icon-circle-green", title: "Apply Fertilizer", badge: "DO", badgeColor: "text-green-500 bg-green-500/10", desc: "Nitrogen level is low. Apply 50kg Urea per acre." },
          ].map((item, i) => (
            <div key={i} className="bg-card rounded-lg p-4 shadow-sm border flex items-start gap-3 animate-fade-up" style={{ animationDelay: `${i * 0.08}s` }}>
              <div className={`icon-circle ${item.circle} shrink-0 w-10 h-10`}>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
          ...
          <div className="bg-card rounded-xl p-5 shadow-sm border animate-fade-up" style={{ animationDelay: "0.1s" }}>
            ...
            <div className="space-y-4">
              {[
                { label: "Soil Moisture", value: "38%", pct: 38, color: "bg-blue-500" },
                { label: "Soil Temp", value: "28°C", pct: 56, color: "bg-orange-500" },
                { label: "Nitrogen", value: "45kg/ha", pct: 45, color: "bg-green-500" },
                { label: "Phosphorus", value: "32kg/ha", pct: 32, color: "bg-green-600" },
                { label: "Potassium", value: "58kg/ha", pct: 58, color: "bg-accent" },
                { label: "pH Level", value: "6.5", pct: 65, color: "bg-blue-400" },
              ].map((item, i) => (
                <div key={i}>
          ...
          <div className="bg-card rounded-xl p-5 shadow-sm border animate-fade-up" style={{ animationDelay: "0.2s" }}>
            ...
            <div className="space-y-4">
              {[
                { name: "Wheat", ndvi: 0.78, status: "Healthy", statusColor: "text-green-500" },
                { name: "Rice", ndvi: 0.52, status: "Moderate", statusColor: "text-orange-500" },
              ...
              <div className="space-y-3">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm font-bold">Today, 6 PM</p>
                  </div>
                </div>
                <div className="flex items-center gap-3">
