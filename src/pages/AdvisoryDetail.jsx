...
const advisoryContent = {
    "low-yield": {
        ...
        icon: Sprout,
        circle: "bg-green-500/10 text-green-500",
        ...
        sections: [
            {
                ...
                subOptions: [
                    { label: "Clay Soil", answer: "Clay soil retains water well. Best crops: Wheat, and Cotton. Ensure good drainage to prevent waterlogging." },
                    { label: "Sandy Soil", answer: "Sandy soil drains quickly. Best crops: Potato, and Watermelon. Use frequent, light irrigation." },
                    { label: "Loamy Soil", answer: "Loamy soil is the most fertile. Best crops: Pulses, and Sugarcane. It has a perfect balance of moisture and air." },
                ]
            },
            {
                id: "yield-2",
                ...
                subOptions: [
                    { label: "Kharif (June–Oct)", answer: "Sown at the start of the monsoon. Major crops: Maize, Pearl Millet, and Soybeans." },
                    { label: "Rabi (Nov–Mar)", answer: "Sown in winter after the monsoon. Major crops: Mustard, Barley, and Gram." },
                    { label: "Zaid (Mar–Jun)", answer: "Short summer season crops. Major crops: Watermelon, Bitter Gourd, and Fodder crops." },
                ]
            },
            {
                id: "yield-3",
            ...
            },
            {
                ...
                subOptions: [
                    ...
                    { label: "Minimal Pesticide", answer: "Use chemical pesticides only as a last resort. Spot-treat affected areas instead of spraying the entire field." },
                ]
            },
        ],
    },
    "water-wastage": {
        ...
        icon: Droplets,
        circle: "bg-blue-500/10 text-blue-500",
        ...
        stats: [
            ...
            { label: "Over-Irrigation Yield Loss", value: "~15%", desc: "Too much water can suffocate roots" },
    ...
    "fertilizer-cost": {
        ...
        icon: FlaskConical,
        circle: "bg-yellow-500/10 text-yellow-500",
        ...
        sections: [
            ...
            },
            {
                ...
                subOptions: [
                    ...
                    { label: "Bio-Fertilizers", answer: "Phosphate Solubilizing Bacteria (PSB) makes fixed phosphorus in soil available to plants." },
                ]
            },
            {
                id: "fert-3",
            ...
            },
            {
                ...
                subOptions: [
                    ...
                    { label: "Split Dosing", answer: "Instead of one big dose, apply in 3 split doses for 20% better nutrient uptake." },
                    { label: "Leaf Color Chart", answer: "A simple plastic chart to check Nitrogen levels based on leaf color, preventing over-application." },
                ]
            },
        ],
    }
...
const AdvisoryDetail = () => {
    ...
    const content = advisoryContent[slug];
    ...
    const handleSubOptionClick = (sectionId, optionLabel) => {
        ...
        <div className="min-h-screen bg-background pb-12">
            ...
            <div className="container max-w-4xl py-6 px-4">
                ...
                <div className="flex flex-col items-center text-center mb-8">
                    <div className={`w-14 h-14 rounded-full flex items-center justify-center ${content.circle} mb-3 shadow-sm`}>
                    ...
                    {content.sections.map((section, i) => {
                        ...
                        return (
                            <AccordionItem
                                key={section.id}
                                value={section.id}
                                className="bg-card rounded-xl px-6 border shadow-sm overflow-hidden animate-fade-up transition-all"
                                                ...
                                                {section.subOptions.map((opt) => (
                                                    <button
                                                        ...
                                                        className={`w-full text-left p-4 rounded-xl border-2 transition-all flex items-center justify-between group ${currentSelected === opt.label
                                                            ...
                                                            : "bg-card hover:bg-muted/30 border-muted text-foreground/80"
                                                            }`}
                                                    >
